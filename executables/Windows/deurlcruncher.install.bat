...
set model_path=%user_path%\Desota\Desota_Models\DeUrlCruncher
:: - Model Execs
set model_uninstall=%model_path%\executables\Windows\deurlcruncher.uninstall.bat
...
ECHO %info_h1%Step 1/6 - Check Re-Instalation%ansi_end%
...
ECHO %info_h1%Step 2/6 - Create Project Folder%ansi_end%
...
:checkinstallpython
ECHO %info_h1%Step 3/6 - Install Python if required%ansi_end%
...
:: GIT MODEL CLONE
ECHO %info_h1%Step 4/6 - Get Project from GitHub%ansi_end%
...
ECHO %info_h1%Step 5/6 - Create Virtual Environment for Project%ansi_end%
...
ECHO %info_h1%Step 6/6 - Install Project Packages%ansi_end%
